...
def get_inbox(recipient: str) -> None:
    """
    Retrieves all the mails in the inbox of the specified recipient by making a GET
    request to the /mail/inbox/{recipient} endpoint.
    
    Args:
        recipient (str): The recipient of the mails to be retrieved.
    
    Returns:
        None
    """
...
def get_sent(sender: str) -> None:
    """
    Retrieves all the mails sent by the specified sender by making a GET request
    to the /mail/sent/{sender} endpoint.
    
    Args:
        sender (str): The sender of the mails to be retrieved.
    
    Returns:
        None
    """
...
def get_mail(mail_id: str) -> None:
    """
    Retrieves a mail entry with the specified mail_id by making a GET request
    to the /mail/{mail_id} endpoint.
    
    Args:
        mail_id (str): The ID of the mail entry to be retrieved.
    
    Returns:
        None
    """
...
def delete_mail(mail_id: str) -> None:
    """
    Deletes a mail entry with the specified mail_id by making a DELETE
